...
epsilon_decay = 1.5             # epsilon decrease
episodes = 250
...
class CliffWalkingDQL():
    ...
    # Train the CliffWalking environment
    def train(self, episodes, memory, render=False, is_slippery=False):
        # Create CliffWalking instance
    ...
    # Run the CliffWalking environment with the learned policy
